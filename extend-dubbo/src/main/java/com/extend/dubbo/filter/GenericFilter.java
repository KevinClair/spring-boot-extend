    ...
    public void onResponse(Result appResponse, Invoker<?> invoker, Invocation inv) {
        if ((inv.getMethodName().equals($INVOKE) || inv.getMethodName().equals($INVOKE_ASYNC))
            ...
            if (appResponse.hasException()) {
                ...
                if (appException instanceof ValidationException || appException instanceof BaseException) {
                    // do nothing
                } else if (!(appException instanceof com.alibaba.dubbo.rpc.service.GenericException)) {
